...
<body>
  ...
  <div class="mb-3">
    ...
    <input name="phone" placeholder="Enter phone number" type=text class="form-control" id="exampleInputPassword1">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Your feedback message</label>
    <textarea rows="8" class="form-control" name="feedback_message" placeholder="Enter message here" class="form-control" id="exampleInputPassword1"></textarea>
  </div>
